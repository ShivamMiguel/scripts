...
async function trimMiraArrays() {
    try {
        await mongoose_1.default.connect("mongodb+srv://statement-admin:cu5xJBInZ2dCnVcU@cluster-st-trading.af1cq.mongodb.net/prod-mirantes-mira?retryWrites=true&w=majority");
